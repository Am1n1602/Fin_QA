...
METRIC_DIRECTION = {
    ...
    "net_interest_margin_pct": "higher",
    "cost_to_income_pct": "lower",     # lower opex relative to income = more efficient
    "credit_cost_pct": "lower",        # lower provisions relative to loan book = better asset quality
    "equity_to_assets_pct": "higher",
}
