...
def combine(company: str, filing_type: str, extracted_dir: str = "data/extracted") -> dict:
    ...
    for f in files:
        ...
        for r in records:
            ...
            # files (re-ran extraction on the same quarter
...
if __name__ == "__main__":
    ...
    out_path = Path("data/analysis") / f"{company}_{filing_type}_combined_ratios.json"
