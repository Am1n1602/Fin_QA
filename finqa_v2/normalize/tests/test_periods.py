"""Period normalization edge cases. python -m unittest finqa_v2.normalize.tests.test_periods"""
from __future__ import annotations

import unittest
from datetime import date

from finqa_v2.normalize.periods import fiscal_year, normalize_period
