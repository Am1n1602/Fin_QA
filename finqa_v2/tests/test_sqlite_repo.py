"""SQLite repository round-trips for finqa_v2. Stdlib unittest.

Run:  python -m unittest finqa_v2.tests.test_sqlite_repo   (from repo root)
"""
...
class TestProtocolConformance(RepoTestCase):
    def test_runtime_checkable(self):
        from finqa_v2 import repositories as R
