...
from database.v2.retrieval.fuse import reciprocal_rank_fusion
from database.v2.retrieval.lexical import BM25Index
from database.v2.retrieval.rerank import IdentityReranker
...
class HybridRetriever:
    ...
    def _load_chunks(self, chunk_ids: list[int]) -> dict[int, DocumentChunk]:
        ...
        from database.v2.sqlite.repo import _row_chunk
