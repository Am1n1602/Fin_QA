...
# database/data/ was deliberately left at the repo root (one level above PROJECT_ROOT,
# which is archive/) when database/src/ moved here -- finqa_v2's own pipeline reads
# from it directly. Unused elsewhere today; kept correct rather than removed.
