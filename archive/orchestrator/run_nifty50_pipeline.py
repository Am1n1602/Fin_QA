...
STAGES: list[tuple[str, str, list[str]]] = [
    ...
    # rag_ingest's cwd is archive/rag/ -- data_extraction/data/ and database/data/ both
    # stayed at the true repo root when their code moved into archive/, hence the extra
    # ../ (finqa_v2's own dataset-rebuild pipeline reads those exact un-moved paths).
